...
export default function BoxBasic() {
  return (
    <p className="content-about">
      Hace unos años en el primer año de la carrera del bachillerato me encontré
      con el maravilloso mundo de la programación, fue difícil al inicio pero
      ...
      aprendido otros lenguajes como PHP o el uso de React Js y ahora me
      enfocaré en C# continuando con un proyecto que quiero mejorar.
    </p>
  );
}
